...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-papErBfKGlC5nUEDqqx7TWv1+Yl8QfHoURTgM7qE9PlgV/7aq+4zOT1Z8GffOiK2GzQwDjz1OZP+JkeP1eZb7Q==" crossorigin="anonymous" referrerpolicy="no-referrer" />
  <style>
    body {
...
<body class="bg-gray-50 text-gray-800">
  ...
  <header class="bg-blue-900 text-white py-6 shadow">
    <div class="max-w-6xl mx-auto px-6 flex items-center space-x-4">
      ...
      <div>
        <h1 class="text-2xl font-bold uppercase">Christian Academy in Davao Oriental Technological Colleges, Inc.</h1>
        <p class="text-sm">UTPRAS AND ASSESSMENT CENTER ACCREDITATION DOCUMENTS</p>
      </div>
    </div>
  </header>
  ...
  <main class="max-w-6xl mx-auto p-6">
    <h2 class="text-xl font-bold mb-4">UTPRAS Registrations</h2>
    <ul class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <li><a href="hybrid.php" class="flex items-center gap-2 p-4 bg-white shadow rounded hover:bg-blue-50 transition"><i class="fas fa-layer-group"></i> Hybrid Apps Development (NTR)</a></li>
      ...
      <li><a href="mcc-ci.php" class="flex items-center gap-2 p-4 bg-white shadow rounded hover:bg-blue-50 transition"><i class="fas fa-car"></i> MCC - Codeigniter Framework</a></li>
       <li><a href="mcc-ci.php" class="flex items-center gap-2 p-4 bg-white shadow rounded hover:bg-blue-50 transition"><i class="fas fa-car"></i> MCC - Print Media</a></li>
    </ul>


    <!-- Assessment Center Section -->
    <section class="mt-12">
      <h2 class="text-xl font-bold mb-4">Assessment Centers Accreditation</h2>
      <ul class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <li>
          <a href="web-dev-ac.php" class="bg-white shadow rounded p-4 flex items-center gap-2 hover:bg-blue-50 transition">
            <i class="fas fa-code"></i> Web Development NC III
          </a>
        </li>
        <li>
          <a href="vgd-ac.php" class="bg-white shadow rounded p-4 flex items-center gap-2 hover:bg-blue-50 transition">
        ...
        <li>
          <a href="bookkeeping-ac.php" class="bg-white shadow rounded p-4 flex items-center gap-2 hover:bg-blue-50 transition">
            <i class="fas fa-book"></i> Bookkeeping NC III
          </a>
        </li>
        <li>
          <a href="driving-ac.php" class="bg-white shadow rounded p-4 flex items-center gap-2 hover:bg-blue-50 transition">
            <i class="fas fa-car"></i> Driving NC II
          </a>
        </li>
      </ul>
    </section>
  ...
  <footer class="bg-gray-200 text-center py-4 mt-10 text-sm">
    &copy; 2025 Christian Academy in Davao Oriental Technological Colleges, Inc. All rights reserved.
  </footer>
