  ...
  <main class="max-w-6xl mx-auto p-6 space-y-6">
    ...
    <section class="bg-white shadow rounded-xl p-6">
      ...
      <ul class="list-disc pl-6 space-y-2">
        ...
        <li><a href="https://drive.google.com/file/d/1amIKetiGIftf7LfuWj-zcQR7x_lJNqNb/view?usp=sharing" target="_blank">Application Reference - Competency Standards ✔️</a> </li>
