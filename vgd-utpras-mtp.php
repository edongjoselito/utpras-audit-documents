      ...
      <div class="flex items-center space-x-4">
        ...
        <div>
          ...
          <span class="inline-block mt-2 px-3 py-1 text-sm font-bold bg-white text-pink-600 rounded-full shadow">
            VISUAL GRAPHIC DESIGN NC III - MOBILE TRAINING PROGRAM (MTP)
          </span>
        </div>
      </div>
  ...
  <main class="max-w-6xl mx-auto p-6 space-y-6">
    ...
    <section class="bg-white shadow rounded-xl p-6">
      ...
      <ul class="list-disc pl-6 space-y-2">
        <li><a href="https://drive.google.com/file/d/1YlS0IZVWkcR8Xda8DWayEeFMLlzW7YkG/view?usp=sharing" target="_blank">Letter of Application/Intent (TESDA-OP-CO-F03)</a></li>
    ...
    <section class="bg-white shadow rounded-xl p-6">
      ...
      <ul class="list-disc pl-6 space-y-2">
        <li><a href="https://drive.google.com/file/d/1njup1nki_1CY6m5tKr91PZSgeew3sud8/view?usp=sharing" target="_blank">Certificate of Program Registration </a> </li>
